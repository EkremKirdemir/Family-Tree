...
namespace FamilyTree
{
    public partial class Form1 : Form
    {
        ...
        string tablePath = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + @"\Test.xlsx";
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            richTextBox1.Text = "Üvey kardeşler:\n";
            await roots[tabControl1.SelectedIndex].FindStepSiblings(wantedPersons, richTextBox1);
            if (wantedPersons.Count > 0)
                endSearchBtn.Enabled = true;
            else
            {
                MessageBox.Show("Soy ağacında üvey kardeş yok!", "Hata");
                EndSearch();
            }
        }
